<x-dash.layout>
    ...
    <div class="mb-9">
        <div id="unitSummary" data-list='{"valueNames":["id", "name"],"page":6,"pagination":true}'>
            <div class="row mb-4 gx-6 gy-3 align-items-center">
                <div class="col-auto">
                    <h2 class="mb-0">{{ $title }}</h2>
                </div>
            </div>
            <form method="POST" action="{{ route('units.bulkDestroy') }}" id="bulk-delete-form">
                @csrf
                @method('DELETE')
                <div class="row g-3 justify-content-between align-items-end mb-4">
                    <div class="col-12 col-sm-auto">
                        <div class="d-flex align-items-center">
                            @can('unit-create')
                                <div class="mt-3 mx-2">
                                    <a class="btn btn-primary btn-sm" href="{{ route('units.create') }}">
                    ...
                    <table class="table fs-9 mb-0 border-top border-translucent">
                        <thead>
                            <tr>
                                ...
                                <th class="sort white-space-nowrap ps-0" scope="col" data-sort="name">Nama Unit</th>
                                @canany(['unit-edit', 'unit-delete'])
                                    <th class="sort text-end" scope="col"></th>
                                @endcanany
                            </tr>
                        </thead>
                        <tbody class="list" id="unit-list-table-body">
                            @php $i = 0; @endphp
