<x-dash.layout>
    ...
    <div class="mb-9">
        <div id="reportSummary"
            data-list='{"valueNames":["id", "date", "description", "status"],"page":6,"pagination":true}'>
            <div class="row mb-4 gx-6 gy-3 align-items-center">
                <div class="col-auto">
                    <h2 class="mb-0">{{ $title }}</h2>
                </div>
            </div>
            <form method="POST" action="{{ route('reports.bulkDestroy') }}" id="bulk-delete-form">
                @csrf
                @method('DELETE')
                ...
                <div class="table-responsive scrollbar">
                    <table class="table fs-9 mb-0 border-top border-translucent">
                        ...
                        <tbody class="list" id="report-list-table-body">
                            @php $i = 0; @endphp
