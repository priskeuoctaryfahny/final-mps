    ...
    <div class="row">
        <div class="col-xl-9">
            <form class="row g-3 mb-6 needs-validation" novalidate="" method="POST"
                action="{{ route('reports.update', $report->id) }}" onsubmit="showLoader()">
                @csrf
                @method('PUT')
                <div class="col-sm-12 col-md-6">
                    <div class="form-floating">
                        <input class="form-control @error('date') is-invalid @enderror" id="date" type="date"
                            name="date" placeholder="Tanggal" value="{{ old('date', $report->date) }}" required />
                ...
                <div class="col-sm-12">
                    <div class="form-floating">
                        <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                            placeholder="Deskripsi" required>{{ old('description', $report->description) }}</textarea>
