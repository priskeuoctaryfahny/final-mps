...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $permissions = [
            ...
            ['name' => 'st-sp-list', 'description' => 'Melihat data ST/SP'],
            ['name' => 'st-sp-create', 'description' => 'Menambah data ST/SP'],
            ['name' => 'st-sp-edit', 'description' => 'Mengubah data ST/SP'],
            ['name' => 'st-sp-delete', 'description' => 'Menghapus data ST/SP'],
            ['name' => 'st-sp-download', 'description' => 'Mengunduh data ST/SP'],
